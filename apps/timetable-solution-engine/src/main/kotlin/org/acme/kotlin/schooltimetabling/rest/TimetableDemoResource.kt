...
class TimetableDemoResource {
    ...
    @APIResponses(
            value =
                    [
                            APIResponse(
                                    responseCode = "200",
                                    description = "Unsolved demo timetable.",
                                    content =
                                            [
                                                    Content(
                                                            mediaType = MediaType.APPLICATION_JSON,
    ...
    @Path("/{demoDataId}")
    fun generate(
            @Parameter(description = "Unique identifier of the demo data.", required = true)
            @PathParam("demoDataId")
            demoData: DemoData
    ): Response {
        val timeslots: MutableList<Timeslot> = ArrayList(10)
        timeslots.add(Timeslot(MONDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)))
        timeslots.add(Timeslot(MONDAY, LocalTime.of(9, 30), LocalTime.of(10, 30)))
        timeslots.add(Timeslot(MONDAY, LocalTime.of(10, 30), LocalTime.of(11, 30)))
        timeslots.add(Timeslot(MONDAY, LocalTime.of(13, 30), LocalTime.of(14, 30)))
        timeslots.add(Timeslot(MONDAY, LocalTime.of(14, 30), LocalTime.of(15, 30)))
        timeslots.add(Timeslot(TUESDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)))
        timeslots.add(Timeslot(TUESDAY, LocalTime.of(9, 30), LocalTime.of(10, 30)))
        timeslots.add(Timeslot(TUESDAY, LocalTime.of(10, 30), LocalTime.of(11, 30)))
        timeslots.add(Timeslot(TUESDAY, LocalTime.of(13, 30), LocalTime.of(14, 30)))
        timeslots.add(Timeslot(TUESDAY, LocalTime.of(14, 30), LocalTime.of(15, 30)))
        if (demoData == DemoData.LARGE) {
            timeslots.add(Timeslot(WEDNESDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)))
            timeslots.add(Timeslot(WEDNESDAY, LocalTime.of(9, 30), LocalTime.of(10, 30)))
            timeslots.add(Timeslot(WEDNESDAY, LocalTime.of(10, 30), LocalTime.of(11, 30)))
            timeslots.add(Timeslot(WEDNESDAY, LocalTime.of(13, 30), LocalTime.of(14, 30)))
            timeslots.add(Timeslot(WEDNESDAY, LocalTime.of(14, 30), LocalTime.of(15, 30)))
            timeslots.add(Timeslot(THURSDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)))
            timeslots.add(Timeslot(THURSDAY, LocalTime.of(9, 30), LocalTime.of(10, 30)))
            timeslots.add(Timeslot(THURSDAY, LocalTime.of(10, 30), LocalTime.of(11, 30)))
            timeslots.add(Timeslot(THURSDAY, LocalTime.of(13, 30), LocalTime.of(14, 30)))
            timeslots.add(Timeslot(THURSDAY, LocalTime.of(14, 30), LocalTime.of(15, 30)))
            timeslots.add(Timeslot(FRIDAY, LocalTime.of(8, 30), LocalTime.of(9, 30)))
            timeslots.add(Timeslot(FRIDAY, LocalTime.of(9, 30), LocalTime.of(10, 30)))
            timeslots.add(Timeslot(FRIDAY, LocalTime.of(10, 30), LocalTime.of(11, 30)))
            timeslots.add(Timeslot(FRIDAY, LocalTime.of(13, 30), LocalTime.of(14, 30)))
            timeslots.add(Timeslot(FRIDAY, LocalTime.of(14, 30), LocalTime.of(15, 30)))
        }
        ...
        if (demoData == DemoData.LARGE) {
            rooms.add(Room("Room D"))
            rooms.add(Room("Room E"))
            rooms.add(Room("Room F"))
        }
        ...
        if (demoData == DemoData.LARGE) {
            ...
            lessons.add(Lesson(nextLessonId++.toString(), "Art", "S. Dali", "9th grade"))
            lessons.add(
                    Lesson(nextLessonId++.toString(), "Physical education", "C. Lewis", "9th grade")
            )
            lessons.add(
                    Lesson(nextLessonId++.toString(), "Physical education", "C. Lewis", "9th grade")
            )
        ...
        if (demoData == DemoData.LARGE) {
            ...
            lessons.add(
                    Lesson(nextLessonId.toString(), "Physical education", "C. Lewis", "12th grade")
            )
        }
        return Response.ok(Timetable(demoData.name, timeslots, rooms, lessons)).build()
    }
}
