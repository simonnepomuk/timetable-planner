...
class TimetableConstraintProviderTest {
    ...
    val ROOM1: Room = Room("Room1")
    val ROOM2: Room = Room("Room2")
    private val TIMESLOT1: Timeslot = Timeslot(DayOfWeek.MONDAY, LocalTime.NOON)
    private val TIMESLOT2: Timeslot = Timeslot(DayOfWeek.TUESDAY, LocalTime.NOON)
    private val TIMESLOT3: Timeslot = Timeslot(DayOfWeek.TUESDAY, LocalTime.NOON.plusHours(1))
    private val TIMESLOT4: Timeslot = Timeslot(DayOfWeek.TUESDAY, LocalTime.NOON.plusHours(3))
    ...
    fun teacherConflict() {
        ...
        val conflictingLesson =
                Lesson("2", "Subject2", conflictingTeacher, "Group2", TIMESLOT1, ROOM2)
    ...
    fun studentGroupConflict() {
        ...
        val conflictingLesson =
                Lesson("2", "Subject2", "Teacher2", conflictingGroup, TIMESLOT1, ROOM2)
        val nonConflictingLesson = Lesson("3", "Subject3", "Teacher3", "Group3", TIMESLOT2, ROOM1)
        constraintVerifier
    ...
    fun studentGroupSubjectVariety() {
        ...
        val firstTuesdayLesson =
                Lesson("2", repeatedSubject, "Teacher2", studentGroup, TIMESLOT2, ROOM1)
        val secondTuesdayLesson =
                Lesson("3", repeatedSubject, "Teacher3", studentGroup, TIMESLOT3, ROOM1)
        val thirdTuesdayLessonWithDifferentSubject =
                Lesson("4", "Subject2", "Teacher4", studentGroup, TIMESLOT4, ROOM1)
        val lessonInAnotherGroup =
                Lesson("5", repeatedSubject, "Teacher5", "Group2", TIMESLOT1, ROOM1)
        constraintVerifier
